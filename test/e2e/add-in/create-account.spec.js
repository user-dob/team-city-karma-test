describe('Create Account', function() {
	...
	it('Create New Account', function (client) {
		...
		var menuAccountSelector = '.select2-results__options .select2_opt_text[data-name="Account"]'
		...
		client
			...
			.waitForElementVisible(menuAccountSelector, 10000).click(menuAccountSelector)
...
//
// describe('Create Account in IE', function() {
//
// 	var name = 'Account-' + Date.now()
//
// 	console.log(name)
...
// 	it('Create New Account', function (client) {
//
// 		var menuAccountSelector = '.select2_opt_text[data-name="Account"]'
//
// 		client
// 			.openSmartCloudConnect({mailTitle: 'Verify your identity in Your Developer Edition'})
//
